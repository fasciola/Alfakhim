...
export default function RainOnGlass() {
    ...
    useEffect(() => {
        ...
        const options = {
            minR: 20, maxR: 50, maxDrops: 300, rainChance: 0.15, rainLimit: 6, // Reduced for performance
        ...
        // ✅ FIXED: Use parent container size instead of window
        function resize() {
        ...
        // ✅ FIXED: Use ResizeObserver instead of window resize
    ...
    // ✅ FIXED: Changed from 'fixed inset-0' to 'absolute inset-0'
    return <canvas ref={canvasRef} className="absolute inset-0" style={{ zIndex: 0, width: '100%', height: '100%', filter: 'saturate(0.7) brightness(0.55)' }} />;
}